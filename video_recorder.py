...
########################
## JRF
## VideoRecorder is based on openCV, respectively. 
...
class VideoRecorder():
	...
	def __init__(self):
		...
		self.open = True
		self.device_index = 0
		self.fps = 20.0 # fps should be the minimum constant rate at which the camera can
		self.fourcc = cv2.VideoWriter_fourcc(*'XVID') # capture images (with no decrease in speed over time; testing is required)
